...
(function () {
  ...
  window.addEventListener('scroll', function () {
    // Keep links and controls clickable during scrolling.
  ...
  /* ------------------------------------------------------------------
     ...
     仕様（materials/03_diagnosis-specification.txt）に合わせて計算する。
       ...
       X = clamp(round(Xraw * 84 / 4), -84, 84)   ※84問の尺度へ正規化
       6段階の境界も84問と同一。
  ...
  function init() {
    ...
    // Native lazy loading preserves the initial network and decode budget.
